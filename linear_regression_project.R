...
setwd("c:/users/alex/documents/linear regression")

##   You might also start by listing the files in your working directory

getwd() # where am I?javascript:;
...
at.region2 <- lm(energy ~ region,
                 data=states.data) 

coef(summary(sat.region2))
...
##No significant differences between the regions
